...
ATOM_NAMES_PER_RESD = defaultdict(
    lambda: ["C4'", "C1'", 'N1', "C2'", "C3'", "C5'", "O2'", "O3'", "O4'", 'C2', 'O2', 'N3', 'C4', 'N4', 'C5', 'C6',
             "O5'",
             'P', 'OP1', 'OP2'])
ATOM_NAMES_PER_RESD.update({
    'A': ["C4'", "C1'", 'N9', "C2'", "C3'", "C5'", "O2'", "O3'", "O4'", 'N1', 'C2', 'N3', 'C4', 'C5', 'C6', 'N6', 'N7',
          'C8', "O5'", 'P', 'OP1', 'OP2'],
    'G': ["C4'", "C1'", 'N9', "C2'", "C3'", "C5'", "O2'", "O3'", "O4'", 'N1', 'N2', 'N3', 'C2', 'C4', 'C5', 'C6', 'N7',
          'C8', 'O6', "O5'", 'P', 'OP1', 'OP2'],
    'U': ["C4'", "C1'", 'N1', "C2'", "C3'", "C5'", "O2'", "O3'", "O4'", 'C2', 'O2', 'N3', 'C4', 'O4', 'C5', 'C6', "O5'",
          'P', 'OP1', 'OP2'],
    'C': ["C4'", "C1'", 'N1', "C2'", "C3'", "C5'", "O2'", "O3'", "O4'", 'C2', 'O2', 'N3', 'C4', 'N4', 'C5', 'C6', "O5'",
          'P', 'OP1', 'OP2'],
    'N': ["C4'", "C1'", 'N1', "C2'", "C3'", "C5'", "O2'", "O3'", "O4'", 'C2', 'O2', 'N3', 'C4', 'N4', 'C5', 'C6', "O5'",
          'P', 'OP1', 'OP2'],
    '-': ["C4'", "C1'", 'N1', "C2'", "C3'", "C5'", "O2'", "O3'", "O4'", 'C2', 'O2', 'N3', 'C4', 'N4', 'C5', 'C6', "O5'",
          'P', 'OP1', 'OP2'],
})
...
BB_ATOMS = ['OP1', 'OP2', 'P', "O5'", "C5'", "C4'", "C3'", "O4'", "C2'", "O2'", "O3'", ]
BASE_ATOMS_purine = sorted(list((set(ATOM_NAMES_PER_RESD['A']) | set(ATOM_NAMES_PER_RESD['G'])) - set(BB_ATOMS)))
BASE_ATOMS_pyrimidine = sorted(list((set(ATOM_NAMES_PER_RESD['C']) | set(ATOM_NAMES_PER_RESD['U'])) - set(BB_ATOMS)))
...
for resd in ['C', 'U', 'N', '-']:
    ATOM_NAMES_to_IDS[resd] = {a: i for i, a in
                               enumerate(BB_ATOMS + [None] * len(BASE_ATOMS_purine) + BASE_ATOMS_pyrimidine)}
ATOM_IDS_PER_RESD = {resd: np.array([ATOM_NAMES_to_IDS[resd][a] for a in ATOM_NAMES_PER_RESD[resd]])
...
BOND_PER_RESD = defaultdict(lambda: [["P", "OP1"], ["P", "OP2"], ["P", "O5'"], ["C5'", "O5'"], ["C5'", "C4'"],
                                     ["C4'", "O4'"], ["C4'", "C3'"], ["O3'", "C3'"], ["C2'", "C3'"], ["C1'", "O4'"],
                                     ["C1'", "C2'"], ])
BOND_PER_RESD['A'].extend([
    ["C1'","N9"], ['N9', 'C8'], ['N9', 'C4'], ['C8', 'N7'], ['N7', 'C5'], ['C5', 'C4'], ['C5', 'C6'], ['C6', 'N6'],
    ['C6', 'N1'], ['N1', 'C2'], ['C2', 'N3'], ['N3', 'C4']
])
BOND_PER_RESD['G'].extend([
    ["C1'","N9"], ['N9', 'C8'], ['N9', 'C4'], ['C8', 'N7'], ['N7', 'C5'], ['C5', 'C4'], ['C5', 'C6'], ['C6', 'O6'],
    ['C6', 'N1'], ['C2', 'N2'], ['N1', 'C2'], ['C2', 'N3'], ['N3', 'C4']
])
BOND_PER_RESD['C'].extend([
    ["C1'","N1"], ['N1', 'C2'], ['N1', 'C6'], ['C2', 'O2'], ['C2', 'N3'], ['N3', 'C4'], ['C4', 'N4'], ['C4', 'C5'],
    ['C6', 'N1'], ['C5', 'C6']
])
BOND_PER_RESD['U'].extend([
    ["C1'","N1"], ['N1', 'C2'], ['N1', 'C6'], ['C2', 'O2'], ['C2', 'N3'], ['N3', 'C4'], ['C4', 'O4'], ['C4', 'C5'],
    ['C6', 'N1'], ['C5', 'C6']
])
